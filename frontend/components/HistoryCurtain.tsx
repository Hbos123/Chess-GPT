            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <div style={{ marginBottom: '16px', fontSize: '12px', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
                  <div>43,000 tokens/day</div>
                  <div>Estimated ~15 messages/day</div>
              ...
              <div style={{ 
                ...
                <div style={{ marginBottom: '16px', fontSize: '12px', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
                  <div>193,500 tokens/day</div>
                  <div>Estimated ~65 messages/day</div>
              ...
              <div style={{ 
                ...
                <div style={{ marginBottom: '16px', fontSize: '12px', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
                  <div>387,000 tokens/day</div>
                  <div>Estimated ~130 messages/day</div>
