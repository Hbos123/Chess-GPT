...
-- Update interaction summary view WITHOUT dropping it (it has dependent views).
-- Keep all existing columns used by dependent views, and append new fields.
...
select
  ...
  -- new fields added in this migration (appended; safe for dependent views)
  i.base_model,
  i.lora_version,
  i.canary_variant,
  ub.user_reprompt_type,
  ub.analysis_abandoned,
  ub.analysis_abandoned_reason,
