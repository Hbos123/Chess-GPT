                        ...
                        compact_ply.append(
                            {
                                ...
                                # Preserve per-move accuracy when provided, otherwise infer.
                                "accuracy_pct": (
                                    r.get("accuracy_pct")
                                    if isinstance(r.get("accuracy_pct"), (int, float)) and float(r.get("accuracy_pct")) > 0
                                    else _infer_accuracy_pct(r)
                                ),
